...
>
    ...
    <span><?php echo esc_html( $order->get_datetime( get_option('date_format') ) ); ?></span>
</div>
...
<div style="padding: 20px; border-radius: 5px">
    ...
    <tbody>
        ...
        <tr>
            ...
            >
                <?php printf( '%s * %s', esc_html( $ticket['etn_ticket_name'] ), esc_html( $ticket['etn_ticket_qty'] ) ); ?>
            </td>
            <td
                style="
                padding: 10px 0;
    ...
    <tbody>
        ...
        >
	        ...
	        <?php echo esc_html__('Subtotal:', 'eventin'); ?>
        </td>
        <td
            style="
            padding: 10px 0;
        ...
        <tr>
            ...
            >
                ...
                <?php echo esc_html__('Discount:', 'eventin'); ?>
            </td>
            <td
                style="
                padding: 10px 0;
        ...
        <tr>
            ...
            <?php echo esc_html__('Tax:', 'eventin'); ?>
            </td>
            <td
                style="
                padding: 10px 0;
        ...
        <?php 
            if ( $order->discount_total > 0 ) {
                $discount_price = $order->discount_total;
            } else {
                $discount_price = 0;
            }
    ...
    <?php echo esc_html__('Payment Method:', 'eventin'); ?>
    <span style="font-weight: bold"><?php
        // Check if the payment method is set and not empty
        if (  $order->payment_method == 'wc' ) {
            echo esc_html__( 'WooCommerce', 'eventin');
        } else {
            // If not set, display a default message
    ...
    <div style="flex: 1 1 50%; display: flex; gap: 8px">
        ...
        <?php 
            if ( $event->event_type == 'offline' ) {
                ...
                echo esc_html( 'Location: ' . $event->get_address() );
                echo '<br>';
