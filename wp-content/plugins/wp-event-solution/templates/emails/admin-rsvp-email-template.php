...
<div>
    ...
    <p style="margin: 8px 0px">RSVP Attendee: Rase12</p>
    <a style="margin: 8px 0px; color: #6c2bd9; font-weight: 600;" href="#">Save your seat</a>
</div>

<!-- Separator -->
<div style="margin: 30px 0; background-color: #c9c9c9; height: 1px"></div>
    ...
    <div style="flex: 1 1 50%; display: flex; gap: 8px">
        ...
        <?php
            ...
            if ( $event->etn_start_date == $event->etn_end_date ) {
                printf( '%s from %s - %s %s', $event->get_start_datetime('l, F d, Y'), $event->get_start_datetime('h:i A'), $event->get_end_datetime('h:i A'), $event->get_timezone() );
            } else {
