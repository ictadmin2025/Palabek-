...
* Added: Interactive Layers have option to create Templates for Panels and Popups. [Example how to make quick view with slider](https://youtu.be/mPLs0_117ww)
* Added: Option for AI edit and generate for Image Element block

= 11.5.1 =

* Added: [AI Helper tools](https://youtu.be/PpGeRu0mZy0)
...
* Added: API Presets for [Dynamic Source and API Connector](https://greenshiftwp.com/api-connector/)
...
* Added: [CSV and Google Sheet option for Dynamic Chart block](https://youtu.be/4rZIGur8t4U)
...
](https://patchstack.com/database/researcher/2e122e4c-5552-442b-98a0-b7fdf72c6976)

= 11.0.2 =

* Added: [Chart Element](https://greenshiftwp.com/dynamic-chart/)
